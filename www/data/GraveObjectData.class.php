...
class GraveObjectData {
    ...
    public function readGraveObject() {
        ...
        return $this -> getDBInfo(0) -> returnObject("Grave", "SELECT idTrackableObject, longitude, latitude, imageDescription, imageLocation, firstName, middleName, lastName, birth, death, G.description, HF.idHistoricFilter, HF.historicFilterName, T.idTypeFilter, TF.type FROM Grave G 
