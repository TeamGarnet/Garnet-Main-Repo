...
class EventService {
    ...
    public function formatEventInfo() {
        ...
        foreach ($allEventObjects as $eventObject) {
            ...
            $formattedEventInfo .= '<div style="margin-bottom: 3%; margin-top: 3%;" class="locationContainer col-xs-12 col-sm-6 col-md-6 col-lg-6"><div class="eventInfo"><p class="eventName">'
