...
class WiderAreaMapService {
    ...
    public function generateInfoWindowConfig($pin, $markerName, $directionName) {
        $infoWindowContent = '"' . "<div><div style = 'width:250px;height:auto;text-align:center'><h4>"
            ...
            . $pin -> getUrl() . "'" . ">Visit Site</a></p><p><a  onclick='calculateAndDisplayRoute(directionsService, directionsDisplay, userLocation, " . '"' . $directionName . '"' .")'>Get Directions</a></p></div></div>" . '"';
