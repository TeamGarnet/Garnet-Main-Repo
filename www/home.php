		...
		<div class="container" id ="footerContainer">
			<div class="row" id = "footerRow">
				...
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 address">
					<h5 style="color:white; text-align:right; margin-top: 0;">19th Ward Community Association — 216 Thurston Road Rochester, NY 14619 - (585)328-6571 - 19thWard@19wca.org</h5>
				</div>
			</div>
		</div>
        <!--<div class="container" id ="footerContainer">
