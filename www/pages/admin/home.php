...
<script type="text/javascript">
    ...
    function deleteNH(id){
        $('.confirm-button').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "../../services/NaturalHistoryService.class.php",
                data: "delete="+String(id),
                dataType:"text",
                success: function(data) {
                    alert(data + String(id));
    ...
    function deleteMisc(id){
        $('.confirm-button').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "../../services/MiscObjectService.class.php",
                data: "delete="+String(id),
                dataType:"text",
                success: function(data) {
                    alert(data + String(id));
    ...
    function deleteType(id) {
        $('.confirm-button').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "../../services/TypeFilterService.class.php",
                data: "delete="+String(id),
                dataType:"text",
                success: function(data) {
                    alert(data + String(id));
    ...
    function deleteHistoricFilter(id) {
        $('.confirm-button').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "../../services/HistoricFilterService.class.php",
                data: "delete="+String(id),
                dataType:"text",
                success: function(data) {
                    alert(data + String(id));
    ...
    function deleteFAQ(id){
        $('.confirm-button').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "../../services/FAQService.class.php",
                data: "delete="+String(id),
                dataType:"text",
                success: function(data) {
                    alert(data + String(id));
    ...
    function deleteLocation(id){
        $('.confirm-button').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "../../services/WiderAreaMapService.class.php",
                data: "delete="+String(id),
                dataType:"text",
                success: function(data) {
                    alert(data + String(id));
    ...
    function deleteContact(id){
        $('.confirm-button').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "../../services/ContactService.class.php",
                data: "delete="+String(id),
                dataType:"text",
                success: function(data) {
                    alert(data + String(id));
    ...
    function deleteEvent(id){
        $('.confirm-button').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "../../services/EventService.class.php",
                data: "delete="+String(id),
                dataType:"text",
                success: function(data) {
                    alert(data + String(id));
