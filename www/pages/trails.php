...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <img class="center-block img-responsive" src="../pages/images/TrailMap.jpg" alt="The trail map would go here under the dora map if the server wasnt being mean to me. Its not loading"/>
        </div>
    </div>
