...
class FilterBar {
    ...
    public function __construct($filterButtonArray) {
        ...
        $filterBarCode = "<nav class='navbar navbar-default navbar-fixed-bottom'><div class='container' id='filterContaier2'><div class='navbar-header'><a class='navbar-brand' href='#'>Select Filters:</a>
        <!-- Mobile Menu -->
