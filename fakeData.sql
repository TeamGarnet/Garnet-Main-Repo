...
('2','American Revolutionary War','1775-04-19','1783-09-03','This was was also known as the american war of independence','1');
...
values('1','Forget-Me-Not','grows on tall, hairy stems which reach two feet in height','Blue blooms with yellow centers','1','2','5'),
('2','Black Raspberries','This plant is native to eastern North America','Black seeded looking fruit','1','1','6'),
('3','Walnut Trees','These trees grow walnuts, a walnut is the seed of a drupe or drupaceous nut','these fall from up high','1','2','7');
...
values ('1','Spongebob','1962-02-21','1989-02-21','he lived in a pineapple under the sea','2','He is under the rock! -bad hint','1','1',NULL),
('2','Squidward','1755-02-23','1777-12-02','he lived next to Spongebob','2','smallest grave in the cemetery','2','2','2'),
('3','Patrick','1845-11-11','1869-01-14','he lived under a rock','2','A pair of graves near the vegetation','3','1','1');
...
values('1','Spring Festival Picnic','The Spring Festival Picnic is a tradition we have where we have people enjoy the day with others');
